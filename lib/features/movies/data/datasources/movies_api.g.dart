...
class _MoviesApi implements MoviesApi {
  ...
  @override
  Future<MoviesResponse> getMovies(Map<String, dynamic> queries) async {
  ...
  Future<GenresResponse> getGenres() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<GenresResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/movies/genres/',
  ...
  @override
  Future<ShowtimesResponse> getMovieShowtimes(String id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ShowtimesResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/movies/${id}/showtimes/',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ShowtimesResponse _value;
    try {
      _value = ShowtimesResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
